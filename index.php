...
<body>
	...
	<main>
		...
		<section class="parallax-container">
			<figure class="parallax"><img alt="paralaxa 1 - laptop z logo strony" src="assets/images/paralax1.png"></figure>
		</section>
		<section class="section white">
			<article class="row container">
				<h2 class="header">Firma ENTER</h2>
				<p class="flow-text grey-text text-darken-3 lighten-3" style="line-height: 300%">
					Jesteśmy specjalistami w dziale IT, w naszym sklepie możesz znaleźć wiele, od zwykłego sprzętu dla nie wymagających klientów,
					komputery dla specjalistów, komputery dla graczy, akcesoria do komputerów, ... i wiele więcej.
					Oferujemy też usługi dla pojedyńczych jednostek jak i dla małych firm, strony internetowe, małe programy, wszystko u nas znajdziesz
					<i class="material-icons">sentiment_very_satisfied</i> .
				</p>
			</article>
			<article class="row container">
				<h2 class="header">Nasi partnerzy</h2>
				<p class="flow-text grey-text text-darken-3 lighten-3" style="line-height: 300%">
					W naszym sklepie można znaleźć sprzęty takich firm jak: DELL, HP, LENOVO, ASUS, MSI, MICROSOFT i wiele innych.
					Posiadamy, oprócz własnych, programy innych firm.
				</p>
			</article>
		</section>
		<section class="parallax-container">
			<figure class="parallax"><img alt="paralaxa 2 - kod programu" src="assets/images/paralax2.png"></figure>
		</section>
	</main>
