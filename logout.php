...
<body>
	...
	<main>
		...
		<section class="container">
			<div class="row section" style="margin-top: 20%; margin-bottom: 25%;">
				<article class="section">
					<h2>Wylogowanie</h2>
					<p> z naszego serwisu przebiegło bez problemów, zostałeś poprawnie wylogowany, oczywiście możesz się ponownie zalogować</p>
				</article>
			</div>
		</section>
	</main>
